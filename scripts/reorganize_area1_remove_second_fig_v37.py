...
BUNDLE_SRC = Path(__file__).resolve().parent.parent / "bundle_assets" / "research-area1-v37"
ASSET_DST = Path("assets/home/research-area1-v37")
...
if not BUNDLE_SRC.exists():
    raise SystemExit("bundle_assets/research-area1-v37 not found. Extract the full zip first.")
...
# Remove previous versions of this homepage research-area block.
for pat in [
...
section = """
<!-- === Homepage research area 1 reorganized v37 START === -->
<section class="home-area1-v37" id="key-thematic-map">
  <div class="area1-v37-heading">
    <p class="eyebrow">Home · Key thematic pathways across the hub</p>
    <h2>Research areas across the hub</h2>
    <p>Each research area connects a practical indoor-positioning challenge with representative works and a clear visual explanation.</p>
  </div>

  <article class="area1-v37-card">
    <div class="area1-v37-top">
      <div class="area1-v37-title">
        <div class="area1-v37-labels">
    ...
    <div class="area1-v37-main">
      <div class="area1-v37-copy">
        <section class="area1-v37-box why-box">
        ...
        <section class="area1-v37-box difficulties-box">
          <h4>Core difficulties</h4>
          <ul>
            <li>Initialization affects the starting position, heading, and early trajectory stability.</li>
            <li>Body-to-platform frame inconsistency appears when the phone orientation does not match the pedestrian walking direction.</li>
            <li>Heading drift accumulates over time because small gyroscope errors integrate into large orientation errors.</li>
            <li>Magnetic disturbance can corrupt compass heading in buildings with steel structures, elevators, electronics, and local magnetic anomalies.</li>
            <li>Pose changes such as holding, calling, swinging, and in-pocket use alter the motion pattern seen by the smartphone sensors.</li>
            <li>Long-term error accumulation makes standalone PDR unreliable unless it is corrected by external cues or contextual constraints.</li>
          </ul>
        </section>
      </div>

      <figure class="area1-v37-figure">
        <img src="assets/home/research-area1-v37/inertial-multipose-route.webp" alt="Inertial positioning trajectories under holding, calling, swinging, mixed use, and in-pocket smartphone poses" loading="lazy" decoding="async">
      </figure>
    </div>

    <div class="area1-v37-works">
...
# Insert as a standalone section before the whole Publication Access section.
...
# Remove all previous CSS variants for Research Area 1 and append a single clean v37 style.
for pat in [
...
.area1-v37-heading p:not(.eyebrow){
  color:#607589;
  font-size:.96rem;
  line-height:1.65;
}
...
.area1-v37-main{
  display:grid;
  grid-template-columns:minmax(360px,.92fr) minmax(520px,1.32fr);
  gap:18px;
  align-items:start;
}
.area1-v37-copy{
...
.area1-v37-works a,
.area1-v37-works a:visited{
  color:#035083;
  text-decoration:none;
  font-weight:400!important;
}
.area1-v37-works a:hover{
  color:#00709c;
  text-decoration:underline;
}
.area1-v37-works span{
  color:#7f90a2;
}
...
print("Done: Research Area 1 reorganized, second figure removed, width reduced, and Core difficulties converted to sentence items.")
